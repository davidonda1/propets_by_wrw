...
import manWithPetImg from '../../../utils/Images/manWithPetImg.svg';
import questionImg from '../../../utils/Images/questionImg.svg';
import petAvatar from '../../../utils/Images/petAvatar.png'
const PetFind = () => {
    return (
        <div>
            <div>
