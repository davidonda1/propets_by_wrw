        ...
        <div className='container'>
            ...
            <div className='container '>
                ...
                <div className='row col-6 label_select'>
                    ...
                    <select className='select mb-2 ml-2'>
                        <option>Male</option>
                ...
                <div className='row col-6 label_input'>
                    <label>Breed:</label>
                    <input className='input ml-3 mb-1' type='text' placeholder='Golden Retriever'/>
                </div>
                <div className='row col-6 label_input'>
                    <label>Color:</label>
                    <input className='input ml-3 mb-1' type='text' placeholder='Beige'/>
                </div>
                <div className='row col-6 label_select'>
                    <label>Height:</label>
                    <select className='select mb-2 ml-2'>
                ...
                <div className='row   '>
                    ...
                    <textarea className='textarea '>blue collar with stars, no left ear, damaged tail.</textarea>
                </div>
                ...
                <div className='row mt-2 '>
                    ...
                    <textarea className='textarea_1 '>brown fox jumps over a lazy dog. DJs flock by when jhkjk jhgMTV ax quiz prog. Junk MTV quiz graced by fox whelps. Bawds jog, flick quartz, vex nymphs.</textarea>

                </div>
                <div className='row mt-2  '>
                    <label className='col-3 '>Location:</label>
                    <textarea className='textarea'>Florentin Street, Tel Aviv</textarea>
                    <div>
